    ...
    <TopbarDashboardLayout currentApp="Expenses">
      <div className="p-6">
        <div className="bg-white p-6 rounded-lg shadow-sm">
          ...
          <p className="text-odoo-gray">Streamline employee expense reporting, submission, and approval processes.</p>
          <div className="mt-6 border-t pt-6">
            <h2 className="text-xl font-semibold text-odoo-dark mb-3">Quick Actions</h2>
            <div className="space-x-2">
              <Button className="bg-odoo-primary text-white hover:bg-odoo-primary/90">Submit Expense Report</Button>
              <Button variant="outline">Approve Reports</Button>
            </div>
          </div>
        </div>
      </div>
